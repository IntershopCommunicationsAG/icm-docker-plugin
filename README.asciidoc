...
| `intershop.as.connector.port` | the host port to be used for the appserver http port | Integer | Optional | `7743` +
| `intershop.servletEngine.connector.container.port` | the container port to be used for the appserver http port (normally no need to change) | Integer | Optional | `7743` +
...
| `intershop.jdbc.url` | JDBC database user | String | Mandatory | <none> +
